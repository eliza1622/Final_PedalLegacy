    ...
    function proceedToRaceRegistration(){
        ...
        selectedPaymentMethod = selected ? (selected.value === 'Credit-Card' ? 'Credit Card' : selected.value) : 'Credit Card';
